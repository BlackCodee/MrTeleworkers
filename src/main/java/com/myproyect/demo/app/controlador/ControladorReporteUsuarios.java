...
public class ControladorReporteUsuarios {

	@Autowired
	private ReporteUsuariosServiceAPI reporteUsuariosServiceAPI;

	@GetMapping(path = "/usuarios/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReporteUsuariosDTO dto = reporteUsuariosServiceAPI.obtenerReporteUsuarios(params);
